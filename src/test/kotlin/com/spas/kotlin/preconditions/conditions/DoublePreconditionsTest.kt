...
class DoublePreconditionsTest {

    private val precondition = object : DoublePreconditions {}
    ...
    fun `test between valid`() {
        val result = precondition.between(1.0, 3.0).test(2.0)
        val expectedResult = Result(true, "expected 2.0 to be between (1.0, 3.0)")
    ...
    fun `test between invalid`() {
        val result = precondition.between(1.0, 3.0).test(4.0)
        val expectedResult = Result(false, "expected 4.0 to be between (1.0, 3.0)")
